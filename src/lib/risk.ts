 ...
 * The risk disclosure.
 *
 * This used to be a modal you had to agree to before the site would render.
 * The modal is gone at the owner request; the obligation is not, so the text
 * runs at the foot of every page instead.
 */
...
export const RISK_POINTS = [
  ...
  "Holding $PLANCK or a broker grants no equity, no ownership, and no claim on the revenue or profit of any company.",
]
