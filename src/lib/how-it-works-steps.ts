 ...
 *
 * The slugs are written down rather than derived from the titles. They are
 * the anchor for every deep link into the page, so editing a title must not
 * silently break a link someone has already shared.
 */
